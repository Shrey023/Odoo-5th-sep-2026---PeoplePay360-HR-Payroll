...
async function main() {
  ...
  const employeesData = [
    { name: 'Aarav Mehta', workEmail: 'aarav@oxp.com', jobPosition: 'Payroll Specialist', departmentId: finance.id, userId: aaravUser.id, wage: '50000', bankAccount: 'HDFC-0001' },
    { name: 'Sara Khan', workEmail: 'sara@oxp.com', jobPosition: 'HR Officer', departmentId: hr.id, wage: '45000', bankAccount: 'ICICI-0002' },
    { name: 'John Dsouza', workEmail: 'john@oxp.com', jobPosition: 'Developer', departmentId: engineering.id, wage: '60000', bankAccount: 'SBI-0003' },
    { name: 'Neha Patel', workEmail: 'neha@oxp.com', jobPosition: 'Recruiter', departmentId: hr.id, wage: '40000', bankAccount: null },
  ]
  ...
  console.log(`  company: ${company.name}, employees: ${employeesData.length}, rules: 7`)
}
