...
const nav = [
  ...
  { to: '/salary-structures', label: 'Salary Structures', icon: Calculator, adminOnly: false },
  { to: '/payruns', label: 'Payruns', icon: Receipt, adminOnly: false },
...
export function AppLayout() {
  ...
  const visibleNav = nav.filter((item) => (item.adminOnly ? hasRole('ADMIN') : true))
  const current = visibleNav.find((n) => isActive(pathname, n.to))
